...
const SelectBotVsBotPage = () => {
    ...
    const bot1_BehaviourComponent = 
        <div className='flex flex-row justify-center items-center flex-wrap w-full mt-2 px-2 gap-5' >
            ...
            <div onClick={() => setBot1_Behaviour('homemade-engine')} className=' h-[110px] w-[110px] flex flex-col justify-start items-center cursor-pointer rounded border-4' style={{borderColor: bot1_Behaviour === 'homemade-engine' ? "rgb(34, 211, 238)" : "rgb(5, 5, 5)" }}  >
                <span className=' w-full h-full flex justify-center items-center rounded' >
                    <Image
...
const bot2_BehaviourComponent = 
    <div className='flex flex-row justify-center items-center flex-wrap w-full mt-2 px-2 gap-5' >
        ...
        <div onClick={() => setBot2_Behaviour('homemade-engine')} className=' h-[110px] w-[110px] flex flex-col justify-start items-center cursor-pointer rounded border-4' style={{borderColor: bot2_Behaviour === 'homemade-engine' ? "rgb(34, 211, 238)" : "rgb(5, 5, 5)" }}  >
            <span className=' w-full h-full flex justify-center items-center rounded' >
                <Image
                    src={botsInfo.get('homemade-engine')?.image || stockfishOnly_pp}
                    alt="Picture of the author"
                    width={150}
                    height={150}
                    // blurDataURL="data:..." automatically provided
    ...
    return (
        <div className="flex flex-col justify-start items-center bg-slate-800 h-[95vh] w-full overflow-auto" >
            ...
            <Link
                className=' w-fit p-3 animate-pulse hover:animate-none hover:bg-cyan-200 flex justify-center items-center text-cyan-300 hover:text-cyan-400 text-3xl font-bold border-2 rounded-lg border-cyan-400 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_30px_#08f] cursor-pointer my-20'
                href = {{
                pathname: '/bot-vs-bot',
                query: {
                    bot1_Elo: bot1_Elo,
