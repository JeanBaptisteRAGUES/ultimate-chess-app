...
export const botsInfo = new Map<Behaviour, BotDescription>([
    ...
    ['bongcloud', {name: 'Hika', description: "Hika sait que dans les finales, il est important de mettre son roi au centre. Alors pourquoi perdre du temps et ne pas le faire dès l'ouverture ?", image: bongcloud_pp}],
    ...
    ['caro-london', {name: 'Henry', description: "Henry aime les ouvertures solides quite à renoncer à challenger son adversaire. Il joue le système de Londres avec les blancs et la caro-kann ou la slav avec les noirs.", image: caroLondon_pp}],
    ['castle-destroyer', {name: 'Brutus', description: "Brutus aime la bagarre et n'est pas là pour conséder la nulle ! Il n'hésitera pas à envoyer des marées de pions sur le roque adverse voir à sacrifier une pièce pour attaquer votre roi, même si le sacrifice est douteux !", image: castleDestroyer_pp}],
    ...
    ['stonewall', {name: 'Golem', description: "Golem aime construire un mur de pion impénétrable et solide comme la roche. C'est donc tout naturellement qu'il joue l'ouverture stonewall avec les blancs comme avec les noirs.", image: stonewall_pp}],
